...
def train(args):
    ...
    # auto log
        ...
        if (os.path.exists("./homework/train_log.txt")):
            os.remove("./homework/train_log.txt")
    # auto log
    ...
    start_epoch = 0
    if (os.path.exists("./homework/train_log.txt")):
        with open("./homework/train_log.txt", 'rb') as f:
    ...
    for epoch in range(args.num_epoch):
        ...
        with open("./homework/train_log.txt", "a") as f:
            f.write(logStr)
